  ...
  return (
    <div className="bg-white rounded-2xl shadow-md border border-border overflow-hidden">
      <div className="p-6 text-center">
        ...
        <p className="text-sm font-semibold text-gray-700 mb-1">{pickup.name} → {destination.name}</p>
        <p className="text-xs text-gray-400 mb-4">Click below for live route with traffic</p>
